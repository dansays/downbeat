...
The scan reads this file, fetches each `Calendar` URL, and extracts upcoming shows.
...
- Notes: Small acoustic listening room; modern & straight-ahead jazz five nights a week.
  Best-aligned venue. "Tuesday Happenings" and "Third Thursdays" are recurring jam-style
  nights — treat as lower priority than billed artist concerts.

## Blue Note (Hollywood)
- Location: Hollywood, Los Angeles
- Calendar: https://www.bluenotejazz.com/la/
- Notes: Books many genres, not just jazz. ONLY include jazz shows — skip non-jazz acts
  (rock, hip-hop, comedy, R&B, etc.) even though they appear on the calendar.

## Vibrato Grill Jazz
- Location: 2930 Beverly Glen Circle, Bel Air (Herb Alpert's club)
- Calendar: https://vibratogrilljazz.com/music
- Notes: Supper club; check for cover/minimum. Books MANY pop/soul tribute acts (ABBA, Bee
  Gees, Steely Dan, Marvin Gaye, etc.) alongside real jazz — lean on the rubric to keep only
  the vocal-standards, swing/big-band, bossa, and Latin-jazz acts; skip pop tributes.

## The Stowaway
- Location: 416 S Spring St, Downtown Los Angeles (Historic Core)
- Calendar: https://stowawaydtla.com
- Notes: Active — free live jazz nightly — BUT the site returns HTTP 403 to automated fetch
  and publishes no machine-readable per-night lineup. Songkick may list some shows
  (https://www.songkick.com/venues/4450566-stowaway). Note it and move on if no lineup found.

## Jazz at LACMA
- Location: Smidt Welcome Plaza, LACMA, 5905 Wilshire Blvd, Los Angeles
- Calendar: https://www.lacma.org/event-calendar-by-day?event_hub=Jazz+at+LACMA
- Notes: FREE outdoor Friday-evening series (6 PM), May–October. No tickets. Because it's
  free and low-risk, **be more permissive here**: don't add acts the rubric says he likely
